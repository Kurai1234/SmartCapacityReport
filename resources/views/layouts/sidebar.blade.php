    ...
    <ul class="navbar--nav">
        ...
        <li class="nav--item {{ Route::currentRouteName() === 'dashboard' ? 'actives' : '' }}">
            <a class="nav--link" href="{{ route('dashboard') }}">
                <svg class="nav--link--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        <li class="nav--item ">
            <a class="nav--link" href="{{ route('accesspoint') }}">
                <svg class="nav--link--svg" class="fa-primary" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                    <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path fill="currentColor"
        ...
        <li class="nav--item">
            <a class="nav--link" href="{{ route('reports') }}">
                <svg class="nav--link--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                    <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path fill="currentColor"
        ...
        @can('manage-accounts')
            <li class="nav--item">
                <a class="nav--link" href="{{ route('admin.manageuser') }}">
                    <svg class="nav--link--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                        <path fill="currentColor"
        ...
        <li class="nav--item">
            <a class="nav--link" href="{{ route('logout') }}"
                ...
                </svg> <span class="title"> Log Out</span>
            </a>
