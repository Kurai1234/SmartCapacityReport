                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td><a class="btn btn-sm btn-primary" href="{{ route('admin.edituser', $user->id) }}">Edit</a>
                                ...
                                <a class="btn btn-sm btn-danger" href="{{ route('admin.deleteuser', $user->id) }}"
                                    onclick="event.preventDefault(); document.getElementById('delete-user-{{ $user->id }}').submit()">Delete
                                </a>
