...
<div class="container-fluid manage--dashboard">
    ...
    <div class="form-row">  
        <div class="form-group col-md-6">
            ...
            <input type="text" required class="form-control" id="name" name="name" placeholder="Name" value="{{old('name','')}}" required>
        </div>                                                                                       
        ...
        <div class="form-group col-md-6">
            ...
            <input type="email" required class="form-control" id="email" name="email" placeholder="Email" value="{{old('email','')}}" required>
        </div>
