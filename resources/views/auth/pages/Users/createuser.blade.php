        ...
        <form method="POST" action={{ route('register') }}>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" required class="form-control" id="user_name" name="user_name" placeholder="UserName"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" name="updateUser">Create User</button>
                        </div>
                    </div>
                </div>
            </div>
